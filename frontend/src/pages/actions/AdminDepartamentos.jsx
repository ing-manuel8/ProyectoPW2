...
const AdminDepartamentos = () => {
    ...
    const obtenerDepartamentos = async () => {
        try {
            ...
            const response = await fetch('http://localhost:5000/api/chatbot/departments', {
                headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const url = selectedDepartamento 
                ? `http://localhost:5000/api/chatbot/departments/${selectedDepartamento._id}`
                : 'http://localhost:5000/api/chatbot/departments';
    ...
    const handleDelete = async () => {
        ...
        try {
            const token = localStorage.getItem('token');
            const response = await fetch(`http://localhost:5000/api/chatbot/departments/${selectedDepartamento._id}`, {
                method: 'DELETE',
                headers: {
                    'Authorization': `Bearer ${token}`,
                    'Content-Type': 'application/json'
